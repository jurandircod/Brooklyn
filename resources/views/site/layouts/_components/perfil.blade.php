                ...
                <ul class="nav nav-tabs custome-nav-tabs flex-column category-option" id="myTab">
                    ...
                    <li class="nav-item mb-2">
                        <button class="nav-link font-light" id="5-tab" data-bs-toggle="tab"
                            data-bs-target="#profile" type="button"><i class="fas fa-angle-right"></i>Perfil</button>
                    </li>
                    ...
                    <li class="nav-item mb-2">
                        <button class="nav-link font-light" id="4-tab" data-bs-toggle="tab" data-bs-target="#pay"
                            type="button"><i class="fas fa-angle-right"></i>Pagamento</button>
                    </li>
                    ...
                    <li class="nav-item">
                        <button class="nav-link font-light" id="6-tab" data-bs-toggle="tab"
                            data-bs-target="#security" type="button"><i
                                class="fas fa-angle-right"></i>Segurança</button>
                    </li>
                    ...
                    <div class="tab-pane fade @isset($activeTab) @if ($activeTab == 3) show active @endif @endisset"
                        ...
                        <div class="">
                            ...
                            <form action="{{ isset($enderecoEditar) ? route('site.perfil.editarEndereco', ['id' => $enderecoEditar->id]) : route('site.perfil.salvarEndereco') }}" method="POST">
                                ...
                                <button type="submit"
                                    class="btn btn-solid-default btn-sm fw-bold rounded mt-3">Salvar</button>
                            </form>
                        </div>
                    </div>
