                ...
                <div class="lg:w-1/4 bg-gray-50 border-r border-gray-200">
                    <div class="sidebar p-4">
                        <ul class="nav nav-tabs flex flex-col space-y-2" id="myTab">
                            <li class="nav-item">
                                <button
                                    class="nav-link w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-gray-200 @if (empty($activeTab) && empty($_GET['activeTab'])) active bg-blue-600 text-white @elseif ((isset($activeTab) && $activeTab == 'dash') || (isset($_GET['activeTab']) && $_GET['activeTab'] == 'dash')) active bg-blue-600 text-white @else text-gray-700 @endif"
                            ...
                            <li class="nav-item">
                                <button
                                    class="nav-link w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-gray-200 @if ((isset($activeTab) && $activeTab == 'profile') || (isset($_GET['activeTab']) && $_GET['activeTab'] == 'profile')) active bg-blue-600 text-white @else text-gray-700 @endif"
                            ...
                            <li class="nav-item">
                                <button
                                    class="nav-link w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-gray-200 @if ((isset($activeTab) && $activeTab == 'endereco') || (isset($_GET['activeTab']) && $_GET['activeTab'] == 'endereco')) active bg-blue-600 text-white @else text-gray-700 @endif"
                            ...
                            <li class="nav-item">
                                <button
                                    class="nav-link w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-gray-200 @if ((isset($activeTab) && $activeTab == 'order') || (isset($_GET['activeTab']) && $_GET['activeTab'] == 'order')) active bg-blue-600 text-white @else text-gray-700 @endif"
                            ...
                            <li class="nav-item">
                                <button
                                    class="nav-link w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-gray-200 @if ((isset($activeTab) && $activeTab == 'save') || (isset($_GET['activeTab']) && $_GET['activeTab'] == 'save')) active bg-blue-600 text-white @else text-gray-700 @endif"
                            ...
                            <li class="nav-item">
                                <button
                                    class="nav-link w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-gray-200 @if ((isset($activeTab) && $activeTab == 'security') || (isset($_GET['activeTab']) && $_GET['activeTab'] == 'security')) active bg-blue-600 text-white @else text-gray-700 @endif"
                ...
                <div class="lg:w-3/4">
                    <div class="content-area p-4 md:p-6">
                        ...
                        <div class="filter-button mb-4 lg:hidden">
                            <button
                                class="btn btn-solid-default w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors filter-btn">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <!-- Dashboard Tab -->
                            <div class="tab-pane fade @if (empty($activeTab) && empty($_GET['activeTab'])) show active @endif"
                                id="dash">
                                <h2 class="text-2xl md:text-3xl font-bold mb-4 text-gray-800">Informações Pessoais</h2>

                                <div
                                    class="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl p-6 mb-6 text-white">
                                    <h6 class="text-lg mb-2 text-white">Olá, <span
                                            class="font-bold text-white">{{ Auth::user()->name }}</span></h6>
                                        ...
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <h3 class="text-3xl font-bold text-white">
                                                    {{ $pedidos->where('status', 'aguardando')->count() }}</h3>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="border border-gray-200 rounded-xl p-5 bg-white">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <a href="#"
                                                class="text-blue-600 hover:text-blue-700 text-sm inline-block mt-2">Alterar
                                                Senha</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border border-gray-200 rounded-xl p-5 bg-white">
                                        ...
                                        <p class="text-gray-600 text-sm">Você não está inscrito em nenhuma newsletter.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade @isset($activeTab) @if ($activeTab == 6) show active @endif @endisset @isset($_GET['activeTab']) @if ($_GET['activeTab'] == 6) show active @endif @endisset"
                                ...
                                <div
                                    ...
                                    <a href="{{ route('site.perfil.exibirEndereco') }}"
                                        class="btn btn-solid-default flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors whitespace-nowrap">
                                    ...
                                    @isset($enderecosMostrar)
                                        ...
                                        @else
                                            @foreach ($enderecosMostrar as $endereco)
                                                <div
                                                    class="border border-gray-200 rounded-xl p-5 bg-white hover:shadow-lg transition-shadow">
                                                    <div class="flex justify-between items-start mb-4 pb-4 border-b">
                                                        <h5 class="text-lg font-semibold text-gray-800">
                                                            {{ $endereco->cidade }}</h5>
                                                        <span
                                                            class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-medium">Casa</span>
                                                    </div>

                                                    <div class="space-y-2 mb-4 text-sm">
                                                        <p class="text-gray-700"><span
                                                                class="font-semibold">Endereço:</span>
                                                            {{ $endereco->bairro }}</p>
                                                        <p class="text-gray-700"><span
                                                                class="font-semibold">Número:</span>
                                                            {{ $endereco->numero }}</p>
                                                        <p class="text-gray-700"><span
                                                                class="font-semibold">Estado:</span>
                                                            {{ $endereco->estado }}</p>
                                                        <p class="text-gray-700"><span class="font-semibold">CEP:</span>
                                                            {{ $endereco->cep }}</p>
                                                        <p class="text-gray-700"><span
                                                                class="font-semibold">Telefone:</span>
                                                            {{ $endereco->telefone }}</p>
                                                    </div>
                            ...
                            <div class="tab-pane fade" id="profile">
                                ...
                                <div class="border border-gray-200 rounded-xl p-6 bg-white mb-6">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label
                                                class="text-sm font-semibold text-gray-700 block mb-1">{{ Auth::user()->name }}</label>
                                        ...
                                        <div>
                                            ...
                                            <p class="text-gray-600">
                                                @if (isset(Auth::user()->enderecos()->first()->bairro))
                                                    {{ Auth::user()->enderecos()->first()->bairro }}
                                                @else
                                ...
                                <div class="border border-gray-200 rounded-xl p-6 bg-white">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">
                                            @if (isset(Auth::user()->enderecos()->first()->telefone))
                                                {{ Auth::user()->enderecos()->first()->telefone }}
                                            @else
                                                Não cadastrado
                                            @endif
                                        </p>
                            ...
                            <div class="tab-pane fade" id="security">
                                <div class="border border-red-200 rounded-xl p-6 bg-red-50">
                                    ...
                                    <p class="text-gray-700 mb-4">Olá <span
                                            class="font-semibold">{{ Auth::user()->name }}</span>, lamentamos saber
                                        que você gostaria de deletar sua conta.</p>
                                    ...
                                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                                        ...
                                        <p class="text-sm text-yellow-700 mb-2">Deletar sua conta removerá
                                            permanentemente seu perfil, configurações e todas as informações associadas.
                                        </p>
                                        <p class="text-sm text-yellow-700">Uma vez deletada, você será desconectado e
                                            não poderá fazer login novamente.</p>
                                    </div>

                                    <button id="btn-delete-account"
                                        class="btn btn-danger flex items-center gap-2 px-6 py-3 bg-red-600 text-white rounded-lg font-semibold hover:bg-red-700 transition-colors"
                                ...
                                <div class="border border-gray-200 rounded-xl p-6 bg-white">
                                    ...
                                    <form
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div class="form-group">
                                                <label for="input-phone"
                                                    ...
                                                    <i class="fas fa-phone text-blue-600"></i> Telefone <span
                                            ...
                                            <div class="form-group">
                                                <label for="input-cep"
                                                    class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                                    <i class="fas fa-mail-bulk text-blue-600"></i> CEP <span
                                                        class="text-red-500">*</span>
                                                </label>
                                                <input type="text"
                                                    class="form-control w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                                ...
                                                @if ($errors->has('cep'))
                                                    <p class="text-red-500 text-xs mt-1">{{ $errors->first('cep') }}
                                                    </p>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                <label for="input-uf"
                                                    class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                                    <i class="fas fa-flag text-blue-600"></i> CPF <span
                                                        class="text-red-500">*</span>
                                                </label>
                                                <input type="text"
                                                    class="form-control w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                                    value="{{ isset($enderecoEditar) ? $enderecoEditar->cpf : old('cpf') }}"
                                                    name="cpf" id="input-cpf" placeholder="000.000.000-00">
                                                @if ($errors->has('cpf'))
                                                    <p class="text-red-500 text-xs mt-1">{{ $errors->first('cpf') }}
                                                    </p>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                                <label for="input-city"
                                                    class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                                    <i class="fas fa-city text-blue-600"></i> Cidade <span
                                                        class="text-red-500">*</span>
                                                </label>
                                                <input type="text"
                                                    class="form-control w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                            ...
                                            <div class="form-group">
                                                <label for="input-uf"
                                                    class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                                    <i class="fas fa-flag text-blue-600"></i> Estado <span
                                                        class="text-red-500">*</span>
                                                </label>
                                                <input type="text"
                                                    class="form-control w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                            ...
                                            <div class="form-group">
                                                <label for="input-logradouro"
                                                    class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                                    <i class="fas fa-road text-blue-600"></i> Logradouro <span
                                                        class="text-red-500">*</span>
                                                </label>
                                            ...
                                            <div class="form-group">
                                                <label for="input-numero"
                                                    class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                                    <i class="fas fa-hashtag text-blue-600"></i> Número <span
                                                        class="text-red-500">*</span>
                                                </label>
                                            ...
                                            <div class="form-group">
                                                <label for="input-bairro"
                                                    class="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                                                    <i class="fas fa-map text-blue-600"></i> Bairro <span
                                                        class="text-red-500">*</span>
                                                </label>
                                        ...
                                        <div class="flex flex-col sm:flex-row gap-3 mt-6">
                                            <button type="submit"
                                                class="btn btn-solid-default flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                                            ...
                                            <a href="/perfil?activeTab=3"
                                                class="btn flex items-center justify-center gap-2 px-6 py-3 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 transition-colors">
